...
import com.kingfish.show.mybatis.model.ShowExample.Criteria;
import com.kingfish.show.mybatis.model.ShowExample.Criterion;
...
public class ShowSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(ShowExample example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated
     */
    public String deleteByExample(ShowExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("show");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(Show record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("show");
     ...
     * @mbg.generated
     */
    public String selectByExample(ShowExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Show record = (Show) parameter.get("record");
        ShowExample example = (ShowExample) parameter.get("example");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(Show record) {
        SQL sql = new SQL();
        sql.UPDATE("show");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, ShowExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
